...
//					System.out.println(allNodes[edge1.getSourceID() - offset].toString() + allNodes[edge1.getSourceID() - offset].getEdges().size());
//					System.out.println(allNodes[edge2.getSourceID() - offset].toString() + allNodes[edge2.getSourceID() - offset].getEdges().size());
